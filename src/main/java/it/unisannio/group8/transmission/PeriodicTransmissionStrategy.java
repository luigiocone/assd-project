...
public class PeriodicTransmissionStrategy implements TransmissionStrategy {
    ...
    public void next(byte[] payload) {
        // TODO: This method is called from inside a callback, study if it's safe
        //  to call a blocking operation inside a paho callback
        threadPool.submit(() -> {
            // Blocking operation
            queue.add(payload);
        });
    ...
    private class TransformAndUse implements Runnable {
        @Override
        public void run() {
